namespace NServiceBus.PersistenceTesting.Sagas
{
    ...
    // Copy of the core persistence test When_persisting_a_saga_with_complex_types because dynamodb reorders lists :(
    public class When_persisting_a_saga_with_complex_types : SagaPersisterTests
    {
        ...
        public async Task It_should_get_deep_copy()
        {
            ...
            CollectionAssert.AreEquivalent(sagaData.Ints, retrieved.Ints);
