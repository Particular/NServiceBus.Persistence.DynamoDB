...
#pragma warning disable CS0618 // Type or member is obsolete - Remove this method along with MessageDrivenSubscriptions
            ...
            {
                throw new Exception("NServiceBus.Persistence.DynamoDB must be used with a transport that provides native publish/subscribe capabilities, and cannot be used with message-driven publish/subscribe.");
            }
